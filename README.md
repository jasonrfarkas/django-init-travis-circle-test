...
testing circle and travis with django init for python3
...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:jasonrfarkas/testpy3-web.git; cd testpy3-web; fab init
...
[contributing]: http://github.com/jasonrfarkas/testpy3-web/tree/master/CONTRIBUTING.md
