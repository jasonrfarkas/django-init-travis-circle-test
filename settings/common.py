...
APPS_DIR = ROOT_DIR.path('testpy3')
...
ADMINS = getaddresses([env("DJANGO_ADMINS", default='testpy3 Admin <admin@example.com>')])
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'testpy3.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "testpy3.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://localhost/testpy3"),
}
